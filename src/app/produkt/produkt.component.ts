...
export class ProduktComponent implements OnInit {
  ...
  getProduct(product: string) {
    if (product == "holztransport") {
      this.images = ["../../assets/images/holztransporte/holztransport1.jpg", "../../assets/images/holztransporte/holztransport2.jpg", "../../assets/images/holztransporte/holztransport3.jpg"];
      ...
      this.brennholz = true;
      this.images = ["../../assets/images/brennholz/brennholz1.jpg", "../../assets/images/brennholz/brennholz2.jpg", "../../assets/images/brennholz/brennholz3.jpg", "../../assets/images/brennholz/brennholz4.jpg"];
      this.greatImag = this.images[0];
      ...
      this.brennholz = true;
      this.images = ["../../assets/images/lt170/lt170_1.jpg", "../../assets/images/lt170/lt170_2.jpg", "../../assets/images//lt170/lt170_3.jpg"];
      this.greatImag = this.images[0];
